...
SECRET_KEY = 'django-insecure-u%y)j_lk@jr)s=!6)m55m+j51p!dt8o6dgsc7sr7$4ykqs*d*n'
...
MIDDLEWARE = [
    ...
    'auths.auth_middleware.KeepAdminLoggedInMiddleware',
...
PROJECT_NAME ='Class Management System'
